    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Latest tech news and updates.", "Technology", "technology" },
                    { 2, "Explore exciting travel destinations and experiences.", "Travel", "travel" },
                    { 3, "Delicious recipes and culinary delights.", "Food", "food" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "Artificial Intelligence", "AI", "ai" },
                    { 2, 0, "Tech and Gadgets", "Technology", "technology-tag" },
                    { 3, 0, "Travel Destinations", "Travel", "travel-tag" }
                });
